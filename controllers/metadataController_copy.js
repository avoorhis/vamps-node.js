...
class CreateDataObj {
  ...
  constructor (req, res, project_id, dataset_ids) {
    ...
    this.all_field_names = this.collect_field_names(this.dataset_ids);
    this.all_metadata = this.prepare_empty_metadata_object(this.pid, this.all_field_names, {});
    //
...
// ...
  ...
  prepare_empty_metadata_object(pid, field_names_arr, all_metadata) {
  ...
  // prepare_empty_metadata_object (pid, all_field_names, {}) {
