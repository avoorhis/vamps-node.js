...
class ShowObj {
  ...
  make_new_project_for_form(rows, req, res, project_obj) {
    ...
    var all_metadata = this.create_all_metadata_form_new(rows, req, res, all_field_names, project_obj);
    // all_metadata = { '485':
    //     { project: [ 'MS_AAA_EHSSU', 'MS_AAA_EHSSU', 'MS_AAA_EHSSU' ],
    //       dataset: ['', '', ''],
    //       sample_name: ['', '', ''],
    ...
    var show_new = module.exports.ShowObj(req, res, all_metadata, all_field_names4, all_field_units);
    show_new.render_edit_form();
  }
...
// saveProject(req, res) { //check if exists in PROJECT_INFORMATION_BY_PID and just pull id and project_obj, render if yes; Project.addProject if new
  ...
  //       this.all_metadata["project_abstract"] = [[],[]];
  //       // all_metadata = { '485':
  //       //     { project: [ 'MS_AAA_EHSSU', 'MS_AAA_EHSSU', 'MS_AAA_EHSSU' ],
  //       //       dataset: ['', '', ''],
  //       //       sample_name: ['', '', ''],
