...
sys.path.append(os.path.expanduser("~/programming/vamps-node.js/"))
from public.emperor_required_resources.format import (format_pcoa_to_js, format_mapping_file_to_js,
