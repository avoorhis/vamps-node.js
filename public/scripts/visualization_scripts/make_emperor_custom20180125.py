...
usage = """usage: make_emperor_custom.py  [options]

"""
parser = argparse.ArgumentParser(description="" ,usage=usage) 
parser.add_argument('-i', '--input_coords',         
                required=True,   action="store",  dest = "input_coords",      
                help = '')  
parser.add_argument('-m', '--map_fp',         
                required=True,   action="store",  dest = "map_fp",        
                help = '')  
parser.add_argument('-o', '--output_dir',         
                required=True,   action="store",  dest = "output_dir",        
                help = '')  
...
#                       "an error will be presented [default: %default]"),      default=None),
