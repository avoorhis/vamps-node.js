...
def go_list(NODE_DATABASE):
    ...
    logging.info('Number of Projects: '+str(num))
...
def go_delete(NODE_DATABASE, pid):
    ...
    print dids  
    # just delete files 
    prefix = os.path.join(os.getcwd(),'public','json',NODE_DATABASE+'--datasets')
    print prefix
    logging.info(prefix)
...
#     prefix = os.path.join(process_dir,'public','json',NODE_DATABASE+'--datasets')
#     print prefix
#     logging.info(prefix)
...
#         print mystr
#         logging.info('Dumping mystr: '+mystr)
...
#     logging.info('process_dir '+process_dir)
#     base = os.path.join(process_dir,'public','json',db+'--datasets')
#     print base
#     logging.info('base dir '+base)
#     files = os.listdir(base)
#     for infile in files:
#         file_path = os.path.join(base,infile)
#         print file_path
...
def go_add(args):
    ...
    logging.info('CMD>'+args.process_dir+'/public/scripts/vamps_script_create_json_dataset_files.py -db '+args.NODE_DATABASE+' -pid '+str(args.pid)+' -pdir '+args.process_dir)
    print('CMD>'+args.process_dir+'/public/scripts/vamps_script_create_json_dataset_files.py -db '+args.NODE_DATABASE+' -pid '+str(args.pid)+' -pdir '+args.process_dir)
    NODE_DATABASE = args.NODE_DATABASE
    pid = args.pid
    process_dir = args.process_dir
    cur.execute("USE "+NODE_DATABASE)
