...
if (domain_ckbxs !== null) {
    ...
    domain_ckbxs[0].addEventListener('change', function () {
    document.getElementById('output_choices_submit_btn').disabled = false;
    document.getElementById('output_choices_submit_btn').innerHTML='<span class="glyphicon glyphicon-alert" aria-hidden="true"></span> Update'
    document.getElementById('output_choices_submit_btn').style.background = '#FF6600';
    });
    domain_ckbxs[1].addEventListener('change', function () {
    document.getElementById('output_choices_submit_btn').disabled = false;
    document.getElementById('output_choices_submit_btn').innerHTML='<span class="glyphicon glyphicon-alert" aria-hidden="true"></span> Update'
    document.getElementById('output_choices_submit_btn').style.background = '#FF6600';
    });
    domain_ckbxs[2].addEventListener('change', function () {
    document.getElementById('output_choices_submit_btn').disabled = false;
    document.getElementById('output_choices_submit_btn').innerHTML='<span class="glyphicon glyphicon-alert" aria-hidden="true"></span> Update'
    document.getElementById('output_choices_submit_btn').style.background = '#FF6600';
    });
    domain_ckbxs[3].addEventListener('change', function () {
    document.getElementById('output_choices_submit_btn').disabled = false;
    document.getElementById('output_choices_submit_btn').innerHTML='<span class="glyphicon glyphicon-alert" aria-hidden="true"></span> Update'
    document.getElementById('output_choices_submit_btn').style.background = '#FF6600';
    });
    domain_ckbxs[4].addEventListener('change', function () {
    document.getElementById('output_choices_submit_btn').disabled = false;
    document.getElementById('output_choices_submit_btn').innerHTML='<span class="glyphicon glyphicon-alert" aria-hidden="true"></span> Update'
    document.getElementById('output_choices_submit_btn').style.background = '#FF6600';
  });
...
function new_window_skeleton(html){
  ...
  txt +="<script type='text/javascript' src='/javascripts/jquery-2.1.1.min.js' defer></script>" +"\n";
  txt +="<script type='text/javascript' src='/javascripts/jquery-ui.min.js' defer></script>"+"\n"
  txt +="<script type='text/javascript' src='/javascripts/bootstrap.min.js' defer></script>"+"\n"
  txt +='<script type="text/javascript" src="/javascripts/tablesort.min.js" defer></script>'+"\n"
  txt +='<script type="text/javascript" src="/javascripts/jquery.scrollTo.min.js" defer></script>'+"\n"
  txt +='<script type="text/javascript" src="/javascripts/jquery.tablednd.js" defer></script>'+"\n"
  txt +='<script type="text/javascript" src="/javascripts/d3.min.js" charset="utf-8" defer></script>'+"\n"
  txt +='<script type="text/javascript" src="/javascripts/d3pie.min.js" charset="utf-8" defer></script>'+"\n"
  txt +='<script type="text/javascript" src="/javascripts/d3.phylogram.js" charset="utf-8" defer></script>'+"\n"
  txt +='<script type="text/javascript" src="/javascripts/d3.phylonator.js" charset="utf-8" defer></script>'+"\n"
  txt +='<script type="text/javascript" src="/javascripts/newick.js" charset="utf-8" defer></script>'+"\n"
  txt +='<script type="text/javascript" src="/javascripts/drag_rows.js" defer></script>'+"\n"
  txt +='<script type="text/javascript" src="/javascripts/global.js" defer></script>'+"\n"
  txt +='<script type="text/javascript" src="/javascripts/common_selection.js" defer></script>'+"\n"
  txt +='<script type="text/javascript" src="/javascripts/view_selection.js" defer></script>'+"\n"
  txt +='<script type="text/javascript" src="/javascripts/bootstrap-select.js" defer></script>'+"\n"
  txt +='<script type="text/javascript" src="/javascripts/jquery.flot.min.js" defer></script>'+"\n"
  txt +="</BODY>"+"\n"
  txt +="</HTML>"+"\n"
  // code for tooltips
  txt +="<script defer>"
