...
constants.ORDERED_METADATA_NAMES = [
    ["structured comment name","Parameter","", "Units"], //MBL Supplied or Optional
    ["","General","", "Units"],
    // ["project","VAMPS project name","MBL Supplied", "Units"],
    ["dataset","VAMPS dataset name","MBL Supplied", "Units"],
    ["sample_name","Sample ID (user sample name)","User supplied", "Units"],
    ["investigation_type","Investigation Type","User supplied", "Units"],
    ["sample_type","Sample Type (most often environmental)","User supplied", "Units"],
    ["collection_date","Sample collection date (YYYY-MM-DD)","User supplied", "Units"],
    ["latitude","Latitude (WGS84 system, values bounded by ±90°)","User supplied", "Units"],
    ["longitude","Longitude (values bounded by ±180°)","User supplied", "Units"],
    ["geo_loc_name_continental","Country","MBL Supplied", "Units"],
    ["geo_loc_name_marine","Longhurst Zone","MBL Supplied", "Units"],
    ["env_package","Environmental Package","User supplied", "Units"],
    ["env_biome","Environmental Biome - Primary","User supplied", "Units"],
    ["biome_secondary","Environmental Biome - Secondary","User supplied", "Units"],
    ["env_feature","Environmental Feature - Primary","User supplied", "Units"],
    ["feature_secondary","Environmental Feature - Secondary","User supplied", "Units"],
    ["env_material","Environmental Material - Primary","User supplied", "Units"],
    ["material_secondary","Environmental Material - Secondary","User supplied", "Units"],
    ["","Enter depth values in one or more categories","", "Units"],
    ["depth_subseafloor","Depth below seafloor","User supplied", "Units"],
    ["depth_subterrestrial","Depth below terrestrial surface","User supplied", "Units"],
    ["depth_in_core","Depth within core","User supplied", "Units"],
    ["tot_depth_water_col","Water column depth (Sampling depth if applicable. If sampling below seafloor, depth of water column at the seafloor)","User supplied", "Units"],
    ["elevation","Elevation above sea level (land only)","User supplied", "Units"],
    ["dna_extraction_meth","DNA Extraction","User supplied", "Units"],
    ["dna_quantitation","DNA Quantitation","User supplied", "Units"],
    ["","Enter either volume or mass","", "Units"],
    ["sample_size_vol","Sample Size (volume)","Optional user supplied", "Units"],
    ["sample_size_mass","Sample Size (mass)","Optional user supplied", "Units"],
    ["formation_name","Formation name","Optional user supplied", "Units"],
    ["access_point_type","Access Point Type","Optional user supplied", "Units"],
    ["","Sample handling","", "Units"],
    ["samp_store_dur","Storage duration","Optional user supplied", "Units"],
    ["samp_store_temp","Storage temperature","Optional user supplied", "Units"],
    ["isol_growth_cond","Isolation and growth condition (publication reference)","Optional user supplied", "Units"],
    ["","MBL generated laboratory metadata","", "Units"],
    ["domain","Domain","MBL Supplied", "Units"],
    ["target_gene","Target gene name (16S rRNA, mcrA)","MBL Supplied", "Units"],
    ["dna_region","DNA region","MBL Supplied", "Units"],
    ["sequencing_meth","Sequencing method","MBL Supplied", "Units"],
    ["forward_primer","Forward PCR Primer","MBL Supplied", "Units"],
    ["reverse_primer","Reverse PCR Primer","MBL Supplied", "Units"],
    ["illumina_index","Index sequence (for Illumina)","MBL Supplied", "Units"],
    ["adapter_sequence","Adapter sequence","MBL Supplied", "Units"],
    ["run","Sequencing run date (YYYY-MM-DD)","MBL Supplied", "Units"],
    ["","Non-biological","", "Units"],
    ["pH","pH","User supplied", "Units"],
    ["temperature","Temperature","User supplied", "Units"],
    ["conductivity","Conductivity","User supplied", "Units"],
    ["resistivity","Resistivity","", "Units"],
    ["salinity","Salinity","", "Units"],
    ["pressure","Pressure","", "Units"],
    ["redox_state","Redox state","", "Units"],
    ["redox_potential","Redox potential","", "Units"],
    ["diss_oxygen","Dissolved oxygen","", "Units"],
    ["diss_hydrogen","Dissolved hydrogen","", "Units"],
    ["diss_org_carb","Dissolved organic carbon","", "Units"],
    ["diss_inorg_carb","Dissolved inorganic carbon","", "Units"],
    ["tot_org_carb","Total organic carbon","", "Units"],
    ["NPOC","NPOC (Non-purgeable organic carbon)","", "Units"],
    ["tot_inorg_carb","Total inorganic carbon","", "Units"],
    ["tot_carb","Total carbon","", "Units"],
    ["calcium_carbonate","Calcium carbonate","", "Units"],
    ["bicarbonate","Bicarbonate","", "Units"],
    ["del18O_water","Delta 18O of water","", "Units"],
    ["part_org_carbon_del13C","Delta 13C for particulate organic carbon","", "Units"],
    ["diss_inorg_carbon_del13C","Delta 13C for dissolved inorganic carbon","", "Units"],
    ["methane_del13C","Delta 13C for methane","", "Units"],
    ["alkalinity","Alkalinity","", "Units"],
    ["calcium","Calcium","", "Units"],
    ["sodium","Sodium","", "Units"],
    ["ammonium","Ammonium","", "Units"],
    ["nitrate","Nitrate","", "Units"],
    ["nitrite","Nitrite","", "Units"],
    ["nitrogen_tot","Total nitrogen","", "Units"],
    ["org_carb_nitro_ratio","Carbon nitrogen ratio","", "Units"],
    ["sulfate","Sulfate","", "Units"],
    ["sulfide","Sulfide","", "Units"],
    ["sulfur_tot","Total sulfur","", "Units"],
    ["chloride","Chloride","", "Units"],
    ["phosphate","Phosphate","", "Units"],
    ["potassium","Potassium","", "Units"],
    ["iron","Total iron","", "Units"],
    ["iron_II","Iron II","", "Units"],
    ["iron_III","Iron III","", "Units"],
    ["magnesium","Magnesium","", "Units"],
    ["manganese","Manganese","", "Units"],
    ["methane","Methane","", "Units"],
    ["noble_gas_chemistry","Noble gas chemistry","", "Units"],
    ["trace_element_geochem","Trace element geochemistry","", "Units"],
    ["porosity","Porosity","", "Units"],
    ["rock_age","Sediment or rock age","", "Units"],
    ["water_age","Water age","", "Units"],
    ["","Biological","", "Units"],
    ["microbial_biomass_FISH","FISH-based cell counts","", "Units"],
    ["microbial_biomass_intactpolarlipid","Microbial biomass – intact polar lipid","", "Units"],
    ["microbial_biomass_microscopic","Microbial biomass – total cell counts","", "Units"],
    ["microbial_biomass_qPCR","qPCR and primers used","", "Units"],
    ["microbial_biomass_platecounts","Microbial biomass – plate counts - cell numbers","", "Units"],
    ["microbial_biomass_avg_cell_number","Microbial biomass – other","", "Units"],
    ["microbial_biomass_wet_weight","Microbial biomass – wet weight","", "Units"],
    ["plate_counts","Plate counts – colony forming units","", "Units"],
    ["functional_gene_assays","functional gene assays (key findings)","", "Units"],
    ["clone_library_results","clone library results (key findings)","", "Units"],
    ["enzyme_activities","enzyme activities (key findings)","", "Units"]
];
