...
config.VISUAL_THUMBNAILS = { visuals: [
    {name:'Distance Heatmap (py)',      thumb:'/images/visuals/heatmap.png',     link:'user_data/heatmap',       id:'dheatmap_link_id'     },
    {name:'Frequency Heatmap (R-pdf)',  thumb:'/images/visuals/frequency_heatmap.png', link:'user_data/frequency_heatmap', id:'fheatmap_link_id'  },
    {name:'Stackbar Charts (d3-svg)',   thumb:'/images/visuals/barcharts.png',   link:'user_data/barcharts',     id:'barcharts_link_id'      },
