...
["-empty-","Enter depth values in one or more categories","User supplied"],
...
["-empty-","MBL generated laboratory metadata","-empty-"],
...
["-empty-","Non-biological","Please use units shown below"],
["pH","pH","-empty-"],
...
["noble_gas_chemistry","Noble gas chemistry","-empty-"],
["trace_element_geochem","Trace element geochemistry","-empty-"],
["rock_type","Rock type","-empty-"],
["lithology","Lithology","-empty-"],
["porosity","Porosity","(percentage)"],
["rock_age","Sediment or rock age","(millions of years)"],
["water_age","Water age","(years)"],
["-empty-","Biological","-empty-"],
...
["functional_gene_assays","Functional gene assays (key findings)","-empty-"],
["clone_library_results","Clone library results (key findings)","-empty-"],
["enzyme_activities","Enzyme activities (key findings)","-empty-"],
