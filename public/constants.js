...
constants.ORDERED_METADATA_NAMES = [
    ...
    ["sample_type","Sample Type (e.g. environmental)","User supplied", ""],
    ["collection_date","Sample collection date","User supplied", "YYYY-MM-DD"],
    ["latitude","Latitude (WGS84 system, values ±90°)","User supplied", "decimal degrees"],
    ["longitude","Longitude (values ±180°)","User supplied", "decimal degrees"],
    ...
    ["elevation","Elevation above sea level (land)","User supplied", "meter"],
    ...
    ["isol_growth_cond","Isolation and growth condition (reference)","User supplied", ""],
