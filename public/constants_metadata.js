...
constants_metadata.ORDERED_METADATA_NAMES_OBJ = {
  ...
  "header User supplied metadata": ["", "User supplied metadata", "", ""],
  ...
  "header Enter depth": ["", "Enter depth values in one or more categories", "", ""],
  ...
  "header Enter either volume or mass": ["", "Enter either volume or mass", "", ""],
  ...
  "header Sample handling": ["", "Sample handling", "", ""],
  ...
  "header Non-biological": ["", "Non-biological", "", ""],
