...
router.post('/metadata_upload',
  ...
  form(
      ...
      form.field("adapter_sequence", "Adapter sequence").trim().entityEncode().array(),
      ...
      form.field("conductivity", "Conductivity").trim().entityEncode().array(),
      ...
      form.field("dna_region", "DNA region").trim().entityEncode().array(),
      form.field("domain", "Domain").trim().entityEncode().array(),
      form.field("elevation", "Elevation above sea level (land only)").trim().entityEncode().array(),
...
form.field("enzyme_activities", "enzyme activities (key findings)").trim().entityEncode().array(),
    ...
    form.field("forward_primer", "Forward PCR Primer").trim().entityEncode().array(),
    form.field("functional_gene_assays", "functional gene assays (key findings)").trim().entityEncode().array(),
    form.field("geo_loc_name_continental", "Country").trim().entityEncode().array(),
    form.field("geo_loc_name_marine", "Longhurst Zone").trim().entityEncode().array(),
    form.field("illumina_index", "Index sequence (for Illumina)").trim().entityEncode().array(),
    form.field("investigation_type", "Investigation Type").trim().entityEncode().array(),
    ...
    form.field("pH", "pH").trim().entityEncode().array(),
    ...
    form.field("project", "VAMPS project name").trim().entityEncode().array(),
    ...
    form.field("redox_state", "Redox state").trim().entityEncode().array(),
    form.field("references", "References").trim().entityEncode().array(),
    form.field("resistivity", "Resistivity").trim().entityEncode().array(),
    form.field("reverse_primer", "Reverse PCR Primer").trim().entityEncode().array(),
    form.field("rock_age", "Sediment or rock age").trim().entityEncode().array(),
    form.field("run", "Sequencing run date (YYYY-MM-DD)").trim().entityEncode().array(),
    ...
    form.field("sample_id", "Sample ID (user sample name)").trim().entityEncode().array(),
    form.field("sample_name", "Sample ID (user sample name)").trim().entityEncode().array(),
    ...
    form.field("sample_type", "Sample Type (most often environmental)").trim().entityEncode().array(),
    form.field("sequencing_meth", "Sequencing method").trim().entityEncode().array(),
    ...
    form.field("target_gene", "Target gene name (16S rRNA, mcrA)").trim().entityEncode().array(),
    form.field("temperature", "Temperature").trim().entityEncode().array(),
