...
router.post('/metadata_upload',
  ...
  form(
    ...
    form.field("alkalinity", helpers.get_second("alkalinity")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("ammonium", helpers.get_second("ammonium")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("bicarbonate", helpers.get_second("bicarbonate")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("env_biome", helpers.get_second("env_biome")).trim().required().custom(metadata_controller.env_items_validation).entityEncode().array(),
    form.field("biome_secondary", helpers.get_second("biome_secondary")).trim().entityEncode().array(),
    form.field("calcium", helpers.get_second("calcium")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("carbonate", helpers.get_second("carbonate")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    ...
    form.field("conductivity", helpers.get_second("conductivity")).trim().custom(metadata_controller.numbers_n_period).required().entityEncode().array(),
    ...
    form.field("depth_in_core", helpers.get_second("depth_in_core")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("depth_subseafloor", helpers.get_second("depth_subseafloor")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("depth_subterrestrial", helpers.get_second("depth_subterrestrial")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("diss_hydrogen", helpers.get_second("diss_hydrogen")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    ...
    form.field("diss_org_carb", helpers.get_second("diss_org_carb")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("diss_oxygen", helpers.get_second("diss_oxygen")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("dna_extraction_meth", helpers.get_second("dna_extraction_meth")).trim().required().custom(metadata_controller.env_items_validation).entityEncode().array(),
    form.field("dna_quantitation", helpers.get_second("dna_quantitation")).trim().required().custom(metadata_controller.env_items_validation).entityEncode().array(),
    ...
    form.field("elevation", helpers.get_second("elevation")).trim().required("", "Elevation is required (for terrestrial only)").custom(metadata_controller.numbers_n_period_n_minus).entityEncode().array(),
    form.field("env_package", helpers.get_second("env_package")).trim().required().custom(metadata_controller.env_items_validation).entityEncode().array(),
    form.field("enzyme_activities", helpers.get_second("enzyme_activities")).trim().entityEncode().array(),
    form.field("env_feature", helpers.get_second("env_feature")).trim().required().custom(metadata_controller.env_items_validation).entityEncode().array(),
    ...
    form.field("geo_loc_name_continental", helpers.get_second("geo_loc_name_continental")).trim().custom(metadata_controller.geo_loc_name_continental_filter).custom(metadata_controller.geo_loc_name_validation).custom(metadata_controller.geo_loc_name_continental_validation).entityEncode().array(),
    form.field("geo_loc_name_marine", helpers.get_second("geo_loc_name_marine")).trim().custom(metadata_controller.geo_loc_name_validation).custom(metadata_controller.geo_loc_name_marine_validation).entityEncode().array(),
    form.field("illumina_index", helpers.get_second("illumina_index")).trim().entityEncode().array(),
    // Index sequence (required for Illumina)
    form.field("intact_polar_lipid", helpers.get_second("intact_polar_lipid")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("investigation_type", helpers.get_second("investigation_type")).trim().required().entityEncode().array(),
    form.field("iron", helpers.get_second("iron")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("iron_ii", helpers.get_second("iron_ii")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("iron_iii", helpers.get_second("iron_iii")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("isol_growth_cond", helpers.get_second("isol_growth_cond")).trim().entityEncode().array(),
    // form.field("latitude", helpers.get_second("latitude")).trim().custom(metadata_controller.latitude_valid).is(/^$|^[0-9.-]+$/).required().entityEncode().array(),
    //, see <a href='https://www.latlong.net/degrees-minutes-seconds-to-decimal-degrees' target='_blank'>a converter</a>
    form.field("latitude", helpers.get_second("latitude")).trim().custom(metadata_controller.latitude_valid).is(/^$|^[0-9.-]+$/, "%s should be in decimal degrees (numbers only). Please see the Tutorial for help").required().entityEncode().array(),
    form.field("longitude", helpers.get_second("longitude")).trim().custom(metadata_controller.longitude_valid).is(/^$|^[0-9.-]+$/, "%s should be in decimal degrees (numbers only). Please see the Tutorial for help").required().entityEncode().array(),
    form.field("magnesium", helpers.get_second("magnesium")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("manganese", helpers.get_second("manganese")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("env_material", helpers.get_second("env_material")).trim().required().custom(metadata_controller.env_items_validation).entityEncode().array(),
    form.field("material_secondary", helpers.get_second("material_secondary")).trim().entityEncode().array(),
    form.field("methane", helpers.get_second("methane")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("methane_del13c", helpers.get_second("methane_del13c")).trim().is(/^$|^[0-9.-]+$/).entityEncode().array(),
    form.field("microbial_biomass_fish", helpers.get_second("microbial_biomass_fish")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    ...
    form.field("nitrate", helpers.get_second("nitrate")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("nitrite", helpers.get_second("nitrite")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("nitrogen_tot", helpers.get_second("nitrogen_tot")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("noble_gas_chemistry", helpers.get_second("noble_gas_chemistry")).trim().entityEncode().array(),
    form.field("org_carb_nitro_ratio", helpers.get_second("org_carb_nitro_ratio")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("ph", helpers.get_second("ph")).trim().custom(metadata_controller.numbers_n_period).custom(metadata_controller.ph_valid).required().entityEncode().array(),
    form.field("part_org_carbon_del13c", helpers.get_second("part_org_carbon_del13c")).trim().is(/^$|^[0-9.-]+$/).entityEncode().array(),
    form.field("phosphate", helpers.get_second("phosphate")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    ...
    form.field("plate_counts", helpers.get_second("plate_counts")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("porosity", helpers.get_second("porosity")).trim().custom(metadata_controller.numbers_n_period).custom(metadata_controller.percent_valid).entityEncode().array(),
    form.field("potassium", helpers.get_second("potassium")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("pressure", helpers.get_second("pressure")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    ...
    form.field("redox_potential", helpers.get_second("redox_potential")).trim().custom(metadata_controller.numbers_n_period_n_minus).entityEncode().array(),
    ...
    form.field("resistivity", helpers.get_second("resistivity")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("reverse_primer", helpers.get_second("reverse_primer")).trim().entityEncode().array(),
    form.field("rock_age", helpers.get_second("rock_age")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("run", helpers.get_second("run")).trim().required().entityEncode().array(),
    form.field("salinity", helpers.get_second("salinity")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    ...
    form.field("sample_size_mass", helpers.get_second("sample_size_mass")).trim().custom(metadata_controller.positive).custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("sample_size_vol", helpers.get_second("sample_size_vol")).trim().custom(metadata_controller.positive).custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("sample_type", helpers.get_second("sample_type")).trim().required().custom(metadata_controller.env_items_validation).entityEncode().array(),
    form.field("sequencing_meth", helpers.get_second("sequencing_meth")).trim().required().entityEncode().array(),
    form.field("silicate", helpers.get_second("silicate")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("sodium", helpers.get_second("sodium")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("sulfate", helpers.get_second("sulfate")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("sulfide", helpers.get_second("sulfide")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("sulfur_tot", helpers.get_second("sulfur_tot")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    ...
    form.field("tot_carb", helpers.get_second("tot_carb")).trim().custom(metadata_controller.numbers_n_period).custom(metadata_controller.percent_valid).entityEncode().array(),
    form.field("tot_depth_water_col", helpers.get_second("tot_depth_water_col")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array(),
    form.field("tot_inorg_carb", helpers.get_second("tot_inorg_carb")).trim().custom(metadata_controller.numbers_n_period).custom(metadata_controller.percent_valid).entityEncode().array(),
    form.field("tot_org_carb", helpers.get_second("tot_org_carb")).trim().custom(metadata_controller.numbers_n_period).custom(metadata_controller.percent_valid).entityEncode().array(),
    form.field("trace_element_geochem", helpers.get_second("trace_element_geochem")).trim().entityEncode().array(),
    form.field("water_age", helpers.get_second("water_age")).trim().custom(metadata_controller.numbers_n_period).entityEncode().array()
  ),
  function (req, res) {
