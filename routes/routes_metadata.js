...
router.post('/metadata_upload',
  ...
  form(
    ...
    form.field("alkalinity", get_second("alkalinity")).trim().isDecimal().entityEncode().array(),
    form.field("ammonium", get_second("ammonium")).trim().isDecimal().entityEncode().array(),
    form.field("bicarbonate", get_second("bicarbonate")).trim().isDecimal().entityEncode().array(),
    ...
    form.field("calcium", get_second("calcium")).trim().isDecimal().entityEncode().array(),
    form.field("carbonate", get_second("carbonate")).trim().isDecimal().entityEncode().array(),
    ...
    form.field("conductivity", get_second("conductivity")).trim().isDecimal().entityEncode().array().required(),
    ...
    form.field("del18O_water", get_second("del18O_water")).trim().isDecimal().entityEncode().array(),
    form.field("depth_in_core", get_second("depth_in_core")).trim().isDecimal().entityEncode().array(),
    form.field("depth_subseafloor", get_second("depth_subseafloor")).trim().isDecimal().entityEncode().array(),
    form.field("depth_subterrestrial", get_second("depth_subterrestrial")).trim().isDecimal().entityEncode().array(),
    form.field("diss_hydrogen", get_second("diss_hydrogen")).trim().isDecimal().entityEncode().array(),
    form.field("diss_inorg_carb", get_second("diss_inorg_carb")).trim().isDecimal().entityEncode().array(),
    form.field("diss_inorg_carbon_del13C", get_second("diss_inorg_carbon_del13C")).trim().isDecimal().entityEncode().array(),
    form.field("diss_org_carb", get_second("diss_org_carb")).trim().isDecimal().entityEncode().array(),
    form.field("diss_oxygen", get_second("diss_oxygen")).trim().isDecimal().entityEncode().array(),
    ...
    form.field("elevation", get_second("elevation")).trim().isDecimal().entityEncode().array().required(),
    ...
    form.field("intact_polar_lipid", get_second("intact_polar_lipid")).trim().isDecimal().entityEncode().array(),
    form.field("investigation_type", get_second("investigation_type")).trim().entityEncode().array().required(),
    form.field("iron", get_second("iron")).trim().isDecimal().entityEncode().array(),
    form.field("iron_II", get_second("iron_II")).trim().isDecimal().entityEncode().array(),
    form.field("iron_III", get_second("iron_III")).trim().isDecimal().entityEncode().array(),
    form.field("isol_growth_cond", get_second("isol_growth_cond")).trim().entityEncode().array(),
    form.field("latitude", get_second("latitude")).trim().isDecimal().required().entityEncode().array(),
    form.field("longitude", get_second("longitude")).trim().isDecimal().required().entityEncode().array(),
    form.field("magnesium", get_second("magnesium")).trim().isDecimal().entityEncode().array(),
    form.field("manganese", get_second("manganese")).trim().isDecimal().entityEncode().array(),
    ...
    form.field("methane", get_second("methane")).trim().isDecimal().entityEncode().array(),
    form.field("methane_del13C", get_second("methane_del13C")).trim().isDecimal().entityEncode().array(),
    form.field("microbial_biomass_FISH", get_second("microbial_biomass_FISH")).trim().isDecimal().entityEncode().array(),
    ...
    form.field("nitrate", get_second("nitrate")).trim().isDecimal().entityEncode().array(),
    form.field("nitrite", get_second("nitrite")).trim().isDecimal().entityEncode().array(),
    form.field("nitrogen_tot", get_second("nitrogen_tot")).trim().isDecimal().entityEncode().array(),
    form.field("noble_gas_chemistry", get_second("noble_gas_chemistry")).trim().entityEncode().array(),
    form.field("org_carb_nitro_ratio", get_second("org_carb_nitro_ratio")).trim().isDecimal().entityEncode().array(),
    form.field("pH", get_second("pH")).trim().isDecimal().entityEncode().array().required(),
    form.field("part_org_carbon_del13C", get_second("part_org_carbon_del13C")).trim().isDecimal().entityEncode().array(),
    form.field("phosphate", get_second("phosphate")).trim().isDecimal().entityEncode().array(),
    ...
    form.field("plate_counts", get_second("plate_counts")).trim().isDecimal().entityEncode().array(),
    form.field("porosity", get_second("porosity")).trim().isDecimal().entityEncode().array(),
    form.field("potassium", get_second("potassium")).trim().isDecimal().entityEncode().array(),
    form.field("pressure", get_second("pressure")).trim().isDecimal().entityEncode().array(),
    ...
    form.field("redox_potential", get_second("redox_potential")).trim().isDecimal().entityEncode().array(),
    ...
    form.field("resistivity", get_second("resistivity")).trim().isDecimal().entityEncode().array(),
    form.field("reverse_primer", get_second("reverse_primer")).trim().entityEncode().array(),
    form.field("rock_age", get_second("rock_age")).trim().isDecimal().entityEncode().array(),
    form.field("run", get_second("run")).trim().entityEncode().array().required(),
    form.field("salinity", get_second("salinity")).trim().isDecimal().entityEncode().array(),
    form.field("samp_store_dur", get_second("samp_store_dur")).trim().entityEncode().array(),
    form.field("samp_store_temp", get_second("samp_store_temp")).trim().isDecimal().entityEncode().array(),
    form.field("sample_name", get_second("sample_name")).trim().entityEncode().array().required(),
    form.field("sample_size_mass", get_second("sample_size_mass")).trim().isDecimal().entityEncode().array(),
    form.field("sample_size_vol", get_second("sample_size_vol")).trim().isDecimal().entityEncode().array(),
    ...
    form.field("silicate", get_second("silicate")).trim().isDecimal().entityEncode().array(),
    form.field("sodium", get_second("sodium")).trim().isDecimal().entityEncode().array(),
    form.field("sulfate", get_second("sulfate")).trim().isDecimal().entityEncode().array(),
    form.field("sulfide", get_second("sulfide")).trim().isDecimal().entityEncode().array(),
    form.field("sulfur_tot", get_second("sulfur_tot")).trim().isDecimal().entityEncode().array(),
    form.field("target_gene", get_second("target_gene")).trim().entityEncode().array().required(),
    form.field("temperature", get_second("temperature")).trim().isDecimal().entityEncode().array().required(),
    form.field("tot_carb", get_second("tot_carb")).trim().isDecimal().entityEncode().array(),
    form.field("tot_depth_water_col", get_second("tot_depth_water_col")).trim().isDecimal().entityEncode().array(),
    form.field("tot_inorg_carb", get_second("tot_inorg_carb")).trim().isDecimal().entityEncode().array(),
    form.field("tot_org_carb", get_second("tot_org_carb")).trim().isDecimal().entityEncode().array(),
    form.field("trace_element_geochem", get_second("trace_element_geochem")).trim().entityEncode().array(),
    form.field("water_age", get_second("water_age")).trim().isDecimal().entityEncode().array()
  ),
  function (req, res) {
