...
router.post('/metadata_upload',
  ...
  form(
    ...
    form.field("biome_secondary", helpers.get_second("biome_secondary")).required().trim().entityEncode().array(),
    ...
    form.field("conductivity", helpers.get_second("conductivity")).trim().custom(helpers.numbers_n_period).custom(helpers.recommended_conduct).entityEncode().array(),
    ...
    form.field("feature_secondary", helpers.get_second("feature_secondary")).required().trim().entityEncode().array(),
    ...
    form.field("geo_loc_name_continental", helpers.get_second("geo_loc_name_continental")).trim().custom(helpers.geo_loc_name_continental_filter).custom(helpers.geo_loc_name_validation).entityEncode().array(),
    form.field("geo_loc_name_marine", helpers.get_second("geo_loc_name_marine")).trim().custom(helpers.geo_loc_name_validation).entityEncode().array(),
    ...
    form.field("material_secondary", helpers.get_second("material_secondary")).required().trim().entityEncode().array(),
    ...
    form.field("sequencing_meth", helpers.get_second("sequencing_meth")).trim().entityEncode().array(),
