...
function make_metadata_object_from_db(req, res) {
  ...
  var AllMetadata_picked = create_AllMetadata_picked(dataset_ids)
        // helpers.slice_object(AllMetadata, dataset_ids);
  ...
  //     AllMetadata_picked[d_id] = [];
  //   }
    has_metadata_in_db(req, res, met_obj, AllMetadata_picked);
    // no_metadata(req, res, met_obj);
    // console.log("There is no metadata for this project and datasets");
    // all_field_names4 = CONSTS.ORDERED_METADATA_NAMES; // move to initial in met_obj
